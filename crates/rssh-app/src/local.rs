...
mod tests {
    ...
    fn terminal_output_filter_answers_decrqss_state_queries() {
        ...
        filter
            .write(
                b"before\x1b[1;2;4;5;8;9;53;38;5;196;48;2;1;2;3m\x1bP$qm\x1b\\ middle\x1b[5 q\x90$q q\x9c after\x1b[2;5r\x1bP$qr\x1b\\done",
                &mut output,
                |response| {
                    responses.extend_from_slice(response);
                    Ok(())
        ...
        assert_eq!(
            output,
            b"before\x1b[1;2;4;5;8;9;53;38;5;196;48;2;1;2;3m middle\x1b[5 q after\x1b[2;5rdone"
        );
        assert_eq!(
            responses,
            b"\x1bP1$r1;2;4;5;8;9;53;38;5;196;48;2;1;2;3m\x1b\\\x1bP1$r5 q\x9c\x1bP1$r2;5r\x1b\\"
        );
    }
