...
- The app answers DEC request status string queries (`DECRQSS`,
  ...
  blink, underline, conceal, strikethrough, overline, inverse video, and colors;
  cursor shape (`SP q`); and scrolling region (`r`), preserving ST versus C1 ST
...
- DECRQSS response: unit tests cover current SGR, including faint, blink, and
