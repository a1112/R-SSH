...
- `Cell` model with character, foreground color, background color, bold, faint,
  italic, underline, strikethrough, and inverse-video attributes.
...
- Basic SGR handling:
  - reset
  - bold, faint, italic, underline, strikethrough, inverse video
...
- SGR color/style parsing, including inverse video, faint, strikethrough, and
