...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  conditionally prepended/appended self-referential title-variable concatenations,
