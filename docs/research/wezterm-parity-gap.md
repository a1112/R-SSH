...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  `tab.active_pane.progress.Percentage`, resolving the ids, index, counts,
  stored user vars, and active-pane progress percentage as text;
