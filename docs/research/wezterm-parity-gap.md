...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  return `pane.title`, `pane.domain_name`, `pane.foreground_process_name`,
  `pane.current_working_dir`, `pane.tty_name`, `tab.active_pane.title`,
  `tab.active_pane.domain_name`, `tab.active_pane.foreground_process_name`,
  ...
  active-pane aliases resolve the active pane/tab title, domain name,
