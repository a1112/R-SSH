...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `command_palette_rows`, `command_palette_bg_color`, `command_palette_fg_color`, `launcher_alphabet`, `quick_select_alphabet`, `quick_select_patterns`,
  ...
  `command_palette_fg_color`, `launcher_alphabet`,
