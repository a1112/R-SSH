...
- Native framebuffer rendering applies basic WezTerm-style
  ...
  cover-style sizing. Richer multi-layer image composition, `Attachment` image
  sources, and alignment/repeat settings remain future parity work.
