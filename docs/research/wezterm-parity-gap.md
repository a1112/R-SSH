...
- Native terminal rendering applies WezTerm-style `colors.background` as the
  ...
  alpha, plus WezTerm `hsl:` and CSS-style `hsl(...)`/`hsla(...)` color
  strings; copy-mode, split, scrollbar, compose, tab-bar, and other
...
- Native terminal rendering applies WezTerm-style `colors.foreground` as the
  ...
  `hsl:` and CSS-style `hsl(...)`/`hsla(...)` color strings; copy-mode, split,
...
- Native terminal rendering applies WezTerm-style `colors.ansi` and
  ...
  implemented CSS-style `rgb(...)`/`hsl(...)`/`hsla(...)` color-string subset.
- Native terminal rendering applies WezTerm-style `colors.indexed` entries for
  ...
  `rgb(...)`/`hsl(...)`/`hsla(...)` color-string subset; unspecified indexed
  entries continue to use the xterm 256-color cube/grayscale mapping.
- Native terminal selection rendering applies WezTerm-style
  ...
  `rgb(...)`/`hsl(...)`/`hsla(...)` subset, including slash alpha for
  `selection_bg`, `selection_fg = 'none'` preserving the current cell
  foreground, plus `selection_bg = 'rgba(r,g,b,a)'` and
  `selection_bg = 'hsla(h,s,l,a)'` alpha blending over the current cell
  background. Broader CSS color parsing and
