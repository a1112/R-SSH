...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `tab_max_width`, `status_update_interval`, `default_prog`,
  `default_domain`, `default_workspace`, `prefer_to_spawn_tabs`,
  `set_environment_variables`, `quit_when_all_windows_are_closed`,
