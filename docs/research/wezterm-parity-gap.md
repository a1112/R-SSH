...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  `tab.active_pane.user_vars['NAME']` static-key values, resolving the ids,
  index, counts, and stored user vars as text;
