...
- Native window now dispatches a typed `new-tab-button-click` hook for
  ...
  native default action exactly once; arbitrary Lua event execution and dynamic
  return logic remain open.
