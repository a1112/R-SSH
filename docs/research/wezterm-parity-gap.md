...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  at render time; arbitrary Lua callbacks and the full Lua config object remain
  open.
