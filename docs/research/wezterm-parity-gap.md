...
- Native framebuffer rendering applies basic WezTerm-style
  ...
  variables to Color sources, explicit Gradient color lists, and preset
  Gradient sources.
