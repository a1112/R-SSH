...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `notification_handling`, plus color scheme and palette fields `colors`,
  `color_scheme`, `color_schemes`, `color_scheme_dirs`, and
  `colors.compose_cursor`/`compose_cursor_color`, dispatches
