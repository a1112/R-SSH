...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  resolving the ids, index, counts, stored user vars, and active-pane progress
  percentage or error value as text;
