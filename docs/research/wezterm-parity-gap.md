...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  field assignments or table initializers, nested parenthesized static callback
