...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  field assignments or table initializers, nested static table-field callback
  expressions from field assignments, table initializers, static table-variable
  aliases, or static callback value aliases, nested parenthesized static callback
