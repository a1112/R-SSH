...
- Command palette now exposes WezTerm-style `ReloadConfiguration`, and the
  ...
  actual update checks and update-window UI remain open. `use_resize_increments`,
  ...
  fields plus the update-check fields parse into the same native override path.
