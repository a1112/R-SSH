...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `max_fps`, `animation_fps`, `front_end`, `webgpu_power_preference`, `prefer_egl`, `enable_wayland`, `cursor_blink_rate`, `cursor_blink_ease_in`, `cursor_blink_ease_out`,
  `text_blink_rate`, `text_blink_rate_rapid`, `text_blink_ease_in`,
