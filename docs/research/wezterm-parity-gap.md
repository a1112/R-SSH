...
- App runtime and console output filtering now track kitty keyboard
  ...
  overrides the cursor color while Builtin preedit text is active. Exact
  platform left/right modifier source tracking, dead-key/leader composition
  cursor parity, deeper platform IME/XIM setup, and broader dynamic
...
- Native user `key_assignments` now dispatch matching regular key presses
  ...
  is active. Exact platform left/right modifier source tracking, dead-key/leader
  composition cursor parity, deeper platform IME/XIM setup, broader dynamic
