...
- Native user `key_assignments` now dispatch matching regular key presses
  ...
  exec/WSL/serial domain connections, stat logger, or process rlimits remains
  open.
