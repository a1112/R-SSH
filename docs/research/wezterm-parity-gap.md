...
- Native split rendering applies WezTerm-style `inactive_pane_hsb` defaults
  ...
  values; dynamic palette-aware resolution for this
...
- Native terminal rendering applies WezTerm-style `foreground_text_hsb`
  ...
  string table keys with long-bracket values; dynamic palette-aware resolution
  for this option remains later parity work.
