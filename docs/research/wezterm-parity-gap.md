...
- Terminal core now base64-decodes iTerm2/WezTerm `OSC 1337;SetUserVar`
  ...
  and static string keys from the same stored metadata, including static `or`
  fallbacks.
