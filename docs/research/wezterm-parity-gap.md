...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  callback variables, top-level static table-field function callbacks from
  field assignments or table initializers, nested static table-field callback
  expressions from field assignments or table initializers, nested parenthesized static callback
