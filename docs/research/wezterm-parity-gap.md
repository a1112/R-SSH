...
- App-shell state now exposes a named WezTerm-style `SwitchToWorkspace` subset
  ...
  subset (`label`, `args`, `cwd`, `set_environment_variables`, and the
  local-domain selector). Remote/mux domains, richer default-mode UI styling,
