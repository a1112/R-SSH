...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  `tab.is_last_active`, `hover`, `#tabs > N`, or `#panes > N` conditions
  followed by a fallback return, plus
