...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `foreground_text_hsb`, `inactive_pane_hsb`, `bold_brightens_ansi_colors`, and
  `text_background_opacity`, plus
...
- Native terminal rendering applies WezTerm-style `bold_brightens_ansi_colors`
  ...
  override path; custom palette resolution remains later parity work.
