...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  with optional `else` fallback assignments, conditionally prepended/appended self-referential title-variable concatenations,
