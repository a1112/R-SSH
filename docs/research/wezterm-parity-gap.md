...
- Native window now dispatches typed `update-status` and deprecated
  ...
  `Error`, and `Indeterminate`, static `pane:get_dimensions()` or
  ...
  static `pane:is_alt_screen_active()` status branches with static
