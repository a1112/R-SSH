...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `text_background_opacity`, `window_background_opacity`, `colors.foreground`, `colors.background`, `colors.ansi`, `colors.brights`, `colors.indexed`, `colors.cursor_bg`, `colors.cursor_border`, and `colors.cursor_fg`, plus
...
- Native terminal rendering applies WezTerm-style `colors.background` as the
  ...
  native override path; copy/selection, split, scrollbar, compose, tab-bar, and
...
- Native terminal rendering applies WezTerm-style `colors.foreground` as the
  ...
  path; copy/selection, split, scrollbar, compose, tab-bar, and other
...
- Native terminal rendering applies WezTerm-style `colors.ansi` and
  ...
  snippets now parse into the same native override path.
- Native terminal rendering applies WezTerm-style `colors.indexed` entries for
  ...
  same native override path; unspecified indexed entries continue to use the
...
- Native cursor rendering applies WezTerm-style `colors.cursor_bg` as the
  ...
  parse into the same native override path; copy/selection, split, scrollbar,
