...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  `tab.window_title`, or `#tabs`, callback-local
  ...
  or tab count at recompute time, including `tostring(...)` wrappers;
