...
- Native framebuffer rendering applies basic WezTerm-style
  ...
  native window background gradient path. Multi-layer composition, image
  sources, alignment/repeat settings, HSB transforms, and semi-transparent
  gradient layers remain future parity work.
