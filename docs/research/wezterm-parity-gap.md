...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `notification_handling`, dispatches `window-config-reloaded`, and allows later
