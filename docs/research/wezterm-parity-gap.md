...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  directly or through simple top-level helper functions, and local
  ...
  returned directly. Simple `..` concatenation returns can combine
