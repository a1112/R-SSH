...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  `force_reverse_video_cursor`, plus the implemented bell/notification subset:
  `audible_bell`, `visual_bell`, `colors.visual_bell`, and
  `notification_handling`, plus
