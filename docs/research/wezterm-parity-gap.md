...
- Native framebuffer rendering applies basic WezTerm-style
  ...
  `window_frame` titlebar/button/border color fields, and ColorSpec fields
  plus static `config.colors` variable mutations now also accept
