...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  `tab.tab_id`, `tab.tab_index`, `tab.tab_title`, `tab.window_title`, or
  `#tabs`, callback-local
