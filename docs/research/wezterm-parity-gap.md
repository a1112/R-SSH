...
- Command palette now exposes WezTerm-style `ReloadConfiguration`, and the
  ...
  overrides for `font_size`, `cell_width`, `cell_widths`, `line_height`, `font_antialias`, `font_hinting`, `font_rasterizer`, `font_colr_rasterizer`, `font_shaper`, `harfbuzz_features`, `tab_max_width`, `status_update_interval`,
