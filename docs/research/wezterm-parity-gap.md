...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  string-variable concatenation, plus top-level static `local <alias> = wezterm.on` event
