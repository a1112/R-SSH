...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  return `tab.tab_title`, `tab.window_title`, or `tab.active_pane.title` resolve
  the current explicit tab title, window title, or pane title at render time;
