...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  callbacks with literal string returns or callback-local static string-variable
