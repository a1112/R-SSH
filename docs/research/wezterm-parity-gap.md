...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  or static-result-variable `wezterm.format` returns through static aliases map onto the same tab-title
