...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  tab count, or active-tab pane count at recompute time, including `tostring(...)` wrappers;
