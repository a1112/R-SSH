...
- Command palette now exposes WezTerm-style `ReloadConfiguration`, and the
  ...
  error window UI, Lua config reload, automatic file watching, and broader Lua
...
- Native window now dispatches a typed `window-config-reloaded` hook for
  ...
  error window UI, actual Lua config reload, automatic file watching, broader
