...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  `string.format` tab-index/tab-count number pairs, and `tab.active_pane.pane_id`,
  resolving the ids, index, and counts as text;
