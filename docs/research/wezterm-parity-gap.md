...
- Native tab bar rendering now dispatches a typed `format-tab-title` hook after
  ...
  concatenations through direct fields, local dynamic title variables, and local
