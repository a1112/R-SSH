...
- App runtime and console output filtering now track kitty keyboard
  ...
  exact platform left/right modifier source tracking, platform IME/XIM
...
- Native user `key_assignments` now dispatch matching regular key presses
  ...
  Ctrl+Alt key bindings. Exact platform left/right modifier source tracking,
  platform IME/XIM connection, preedit rendering, broader dynamic `cell_widths`
