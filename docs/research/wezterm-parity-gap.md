...
- Default `Ctrl+Shift+F`/`Super+F` search shortcuts now expose WezTerm-style
  ...
  action calls resolve top-level string variables for table pattern fields and
