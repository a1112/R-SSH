...
- Command palette now exposes WezTerm-style `ReloadConfiguration`, and the
  ...
  `about_to_wait` to the configured frame interval; dedicated
  `animation_fps` redraw scheduling remains open. `front_end` is retained
