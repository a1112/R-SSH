...
- Native window now dispatches a typed `format-window-title` hook after
  ...
  expressions from field assignments, table initializers, or static table-variable
  aliases, nested parenthesized static callback
