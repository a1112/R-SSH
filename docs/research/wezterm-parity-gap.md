...
- Native user `key_assignments` now dispatch matching regular key presses
  ...
  SSH config host enumeration, exec/WSL/Unix/SSH/serial domain connections,
  Unix socket/proxy timeout application, SSH timeout/backend/multiplexing
